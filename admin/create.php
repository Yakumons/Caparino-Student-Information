...
// Get form values if re-displaying
$student_number = isset($_SESSION['old_student_number']) ? $_SESSION['old_student_number'] : '';
$lastname = isset($_SESSION['old_lastname']) ? $_SESSION['old_lastname'] : '';
$firstname = isset($_SESSION['old_firstname']) ? $_SESSION['old_firstname'] : '';
$email = isset($_SESSION['old_email']) ? $_SESSION['old_email'] : '';
$phone = isset($_SESSION['old_phone']) ? $_SESSION['old_phone'] : '';
$address = isset($_SESSION['old_address']) ? $_SESSION['old_address'] : '';
                ...
                <form action="../process.php" method="POST">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-dark">
                            <i class="bi bi-check-lg me-2"></i>Save Student
                        </button>
                        <a href="index.php" class="btn btn-outline-secondary">
